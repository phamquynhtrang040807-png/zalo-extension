...
- Sau khi dòng Sheet append thành công, worker gửi trực tiếp lần lượt các tin nhắn đã cấu hình, không tạo lời mời kết bạn. Bấm thu thập lại sẽ tạo dòng Sheet và lượt delivery mới.
- Automation không tạo hoặc chờ lời mời kết bạn; task tin nhắn được tạo ngay sau khi append Sheet thành công.
